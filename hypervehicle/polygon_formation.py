...
class Polygon_formation:
    ...
    def generate(self) -> None:
        ...
        assert bool(self.patches['polygons']), "Error! No polygon patches detected."+\
...
#        self.patches['polygons'] = poly_gen_main(self.polygons, self.verbosity)
    ...
    def _create_grids(self) -> None:
        ...
        for poly_patch_dict in self.patches['polygons']:
            ...
            for key in poly_patch_dict:
                poly_grid_dict[key] = StructuredGrid(psurf=poly_patch_dict[key],
    ...
    def _write_to_vtk(self,) -> None:
        ...
        for poly_grid_dict in self.grids['polygons']:
            ...
            for key in poly_grid_dict:
                poly_grid_dict[key].write_to_vtk_file('{}-poly{}_{}.vtk'.format(
                                                        self.vtk_filename, COUNTER, key))                
    ...
    def _create_surfaces(self,) -> None:
        ...
        for poly_patch_dict in self.patches['polygons']:
            poly_stl_mesh_list = []
            for key in poly_patch_dict:
                poly_stl_mesh_list.append(parametricSurfce2stl(poly_patch_dict[key],
                                                                self.stl_resolution))
