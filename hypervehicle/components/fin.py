...
class Fin(Component):
    ...
    def generate_patches(self):
        ...
        p3p3_top = Line(p0=p3 + Vector3(0, 0, fin_thickness_function_bot(x=p3.x, y=p3.y).z), p1=p3)
        p3p3_bot = Line(p0=p3, p1=p3 + Vector3(0, 0, fin_thickness_function_top(x=p3.x, y=p3.y).z))
        ...
        p0p0_top = Line(p0=p0, p1=p0 + Vector3(0, 0, fin_thickness_function_bot(p0.x, p0.y).z))
        p0_botp0 = Line(p0=p0 + Vector3(0, 0, fin_thickness_function_top(p0.x, p0.y).z), p1=p0)
        p3p3_top = Line(p0=p3, p1=p3 + Vector3(0, 0, fin_thickness_function_bot(p3.x, p3.y).z))
        p3_botp3 = Line(p0=p3 + Vector3(0, 0, fin_thickness_function_top(p3.x, p3.y).z), p1=p3)
        ...
        if self.params["rudder_type"] == "sharp":
            ...
            p0_top = p0 - Vector3(0, 0, fin_thickness / 2)  # TODO: remove refernce to constant thickness
            ...
            # print(f"north={p0_topp1_top}, south={p0p1}, east={p1p1_top}, west={p0p0_top}")
