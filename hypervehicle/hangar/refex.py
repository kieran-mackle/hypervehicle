...
class ParametricReFEX(AbstractGenerator):
    def __init__(self, **kwargs) -> None:
        # Vehicle parameters
        self.h = 2.5  # Ogive height ??
        self.r_n = 0.75  # Nose radius
        self.r_o = 10  # Ogive radius
        self.L_o = 0.5
        self.L_b = 22  # Body length
    ...
    def create_instance(self) -> Vehicle:
        ...
        B0 = A0 + Vector3(x=0, y=wing_span + self.h)
