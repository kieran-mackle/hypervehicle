...
class ParametricMdof(Generator):
    def __init__(self, **kwargs) -> None:
        ...
        # Inputs
        self.h = 0.0225  # Ogive radial height (R)
        self.r_n = 0.002  # Nose radius
        self.r_o = 0.125  # Ogive radius
        self.L_o = 0.01225  # Nose-body fairing
        self.L_b = 0.175  # Body length
        self.fin_thickness = 0.003  # Thickness of fin
        self.wing_length = 0.07  # Wing chord property
        self.wing_span = 0.015  # Wing span
        self.fin_height = 0.01 
        self.fin_length = 0.03
        self.tail_height = 0.3  # Tail fin height
        self.tail_thickness = 0.005  # Tail fin thickness
        ...
        self.cannard_shift = Vector3(x=0.0, y=0)
    ...
    def create_instance(self):
        ...
        shift_in = Vector3(x=0, y=-0.02 * self.fin_height)

        p0 = f1 - Vector3(x=self.fin_length, y=0) + shift_in + self.cannard_shift
        p1 = p0 + Vector3(x=0.0, y=self.fin_height) + shift_in
        p2 = p1 + Vector3(x=0.3 * self.fin_length, y=0) + shift_in
        ...
        def wing2_tf_top(x, y, z=0):
            z_ba = -(x - self.L_b) * np.tan(beta)
            return Vector3(x=0, y=0, z=-wing_thickness / 2 - z_ba)
        ...
        if self.generate_wings:
            ...
            mdof.add_component(wing, reflection_axis="y")
        ...
        # x3 = -2.
        x3 = bb1.x + 0.175 #2 * self.wing_length
        ...
        #         stl_resolution=3,
        #     )
        #     mdof.add_component(tail)

        # Apply Cart3D transformation
        # mdof.add_vehicle_transformations(CART3D)
