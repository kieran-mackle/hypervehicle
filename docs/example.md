...
These can be hard coded or treated as variables.
...
x43 = Vehicle()
x43.configure(name='X-43A', verbosity=1, write_stl=True,
              stl_resolution=5, stl_filename='x43')
```

### Body Geometry
Created from a **wing** component type.
...
x43.add_wing(A0=A0, A1=A1, TT=TT, B0=B0, Line_B0TT=Line_B0TT,
...
x43.add_wing(A0=fA0, A1=fA1, TT=fTT, B0=fB0, Line_B0TT=Line_fB0TT,
             top_tf=wing2_tf_top, bot_tf=wing2_tf_bot,
             flap_length=flap_length, flap_angle=flap_angle,
             LE_wf=leading_edge_width_function)
```
...
x43.add_wing(A0=iA0, A1=iA1, TT=iTT, B0=iB0, Line_B0TT=Line_iB0TT,
             top_tf=inlet_tf_top, bot_tf=inlet_tf_bot,
...
def fin_thickness_function_top(x, y, z=0):
    return Vector3(x=0., y=0., z=-fin_thickness/2)
...
fin_geom_dict = {'p0': p0, 'p1': p1, 'p2': p2, 'p3': p3,
...
## Inertial Estimates
The inertial properties of a vehicle can be estimated using the STL meshes
generated by *hypervehicle*. This requires providing effective densities for
...
fin1 = x43.meshes['fin'][0]
fin2 = x43.meshes['fin'][1]
