...
def test_wing():
    ...
    wing.add_wing(A0=A0, A1=A1, TT=TT, B0=B0, Line_B0TT=Line_B0TT,
               top_tf=wing1_tf_top, bot_tf=wing1_tf_bot, flap_length=flap_length,
               flap_angle=flap_angle, LE_wf=leading_edge_width_function)
    
    # Generate stl
    wing.configure(verbosity=1, write_stl=True,
                   stl_resolution=2, stl_filename='wingtest')
    wing.mirror = True
    wing.generate()
