...
hifire8.add_fuselage(Xn=Xn, X1=X1, X2=X2, X3=X3,
                     Rn=Rn, R1=R1, R2=R2, R3=R3)
...
fin1_geom_dict = {'p0': p0, 'p1': p1, 'p2': p2, 'p3': p3,
...
hifire8.add_wing(A0=A0, A1=A1, TT=TT, B0=B0, Line_B0TT=Line_B0TT,
...
hifire8.add_wing(A0=A0n, A1=A1n, TT=TTn, B0=B0n, Line_B0TT=Line_B0TTn,
                 top_tf=nose_tf_top, bot_tf=nose_tf_bot, 
                 LE_wf=leading_edge_width_function, LE_type='FLAT'
                 )
